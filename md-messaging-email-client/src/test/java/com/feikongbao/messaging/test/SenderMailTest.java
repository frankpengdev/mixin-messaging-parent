...
public class SenderMailTest {
    ...
    public void testMail() throws Exception{
        ...
        String from = "jinjun_luo@126.com";
        ...
        List<String> cc = to;
        List<String> bcc = to;
        String subject = "RabbitMQ测试发送邮件01";
        ...
        emailServiceEntity.setUsername("jinjun_luo@126.com");
        emailServiceEntity.setPassword("jjluo1234");
        emailServiceEntity.setHost("smtp.126.com");

        senderMailService.sendMail(from, to, cc, bcc, subject, content, filePaths,6789L, emailServiceEntity);
    }
