package com.mixin.messaging.core.sender;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.mixin.config.company.CompanyRabbitMqConfig;
import com.mixin.messaging.core.enums.MessagingEnum;
import com.mixin.messaging.core.exception.MessagingCoreException;
import com.mixin.messaging.core.service.MessagingCoreService;
...
public class SenderMessage<T> implements RabbitTemplate.ConfirmCallback, RabbitTemplate.ReturnCallback,InitializingBean {
    ...
    @Autowired
    private CompanyRabbitMqConfig companyRabbitMqConfig;
    ...
    public void confirm(CorrelationData correlationData, boolean ack, String cause) {
        if (!ack && correlationData instanceof CallbackCorrelationData) {
            ...
            if (callbackCorrelationData.getRetryCount() < companyRabbitMqConfig.rabbitmqConfirmRetryCount) {
                // 重试次数 + 1
